...
function createPdfiumEngine(wasmUrl, logger) {
  ...
  worker.postMessage({
    type: "wasmInit",
    wasmUrl,
    logger: logger ? serializeLogger(logger) : void 0
  });
...
//# sourceMappingURL=worker-engine.js.map
